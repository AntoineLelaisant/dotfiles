...
_G.packer_plugins = {
  ...
  ["fzf-lua"] = {
    config = { "\27LJ\1\0022\0\0\2\0\2\0\0044\0\0\0%\1\1\0>\0\2\1G\0\1\0\23plugins.config.fzf\frequire\0" },
    loaded = true,
    path = "/home/antoine/.local/share/nvim/site/pack/packer/start/fzf-lua"
  },
  ["galaxyline.nvim"] = {
    loaded = true,
  ...
  ["nvim-fzf"] = {
    loaded = true,
    path = "/home/antoine/.local/share/nvim/site/pack/packer/start/nvim-fzf"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
  ...
  phpactor = {
    loaded = false,
    needs_bufread = true,
    path = "/home/antoine/.local/share/nvim/site/pack/packer/opt/phpactor"
  },
  ["plenary.nvim"] = {
    loaded = true,
  ...
  ["vim-bufkill"] = {
    loaded = true,
    path = "/home/antoine/.local/share/nvim/site/pack/packer/start/vim-bufkill"
  },
  ["vim-bufonly"] = {
    loaded = true,
    path = "/home/antoine/.local/share/nvim/site/pack/packer/start/vim-bufonly"
  },
  ["vim-polyglot"] = {
    loaded = true,
  ...
  ["vim-vsnip"] = {
    config = { "\27LJ\1\0024\0\0\2\0\2\0\0044\0\0\0%\1\1\0>\0\2\1G\0\1\0\25plugins.config.vsnip\frequire\0" },
    loaded = false,
    needs_bufread = false,
...
try_loadstring("\27LJ\1\0022\0\0\2\0\2\0\0044\0\0\0%\1\1\0>\0\2\1G\0\1\0\23plugins.config.fzf\frequire\0", "config", "fzf-lua")
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lsp-colors.nvim', 'nvim-spectre', 'lspsaga.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
